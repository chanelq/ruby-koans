...
class AboutHashes < Neo::Koan
  ...
  def test_accessing_hashes_with_fetch
    ...
    # By default, using #[] will retrieve the hash value if it exists,
    # and return nil if it doesn't exist.
  ...
  def test_changing_hashes
    ...
    # Ruby thinks that { ... } is a block. So, you should 'break it out into
    # a variable' but you always can use
  ...
  def test_default_value
    ...
    # creates a hash with a default value
  end
  ...
  def test_default_value_is_the_same_object
    ...
    # First, note that this behavior applies to any default value that is subsequently
    # mutated (e.g. hashes and strings), not just arrays.

    # Use Hash.new { |h, k| h[k] = [] } if you want the simplest, most idiomatic solution.
  end
